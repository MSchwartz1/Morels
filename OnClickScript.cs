...
public class OnClickScript : MonoBehaviour
{
	...
	private void Start()
	{
		...
		cookButton = GameObject.Find("CookButton(Clone)");
		stickButton = GameObject.Find("StickButton(Clone)");
	...
	void OnMouseDown()
	{
		...
		if (!cookScript.cooking && !stickScript.trading) {
            ...
            else if (gameController.Hand.Contains(gameObject))
            {
                ...
                if (gameObject.name == "Pan")
                {
                    ...
                    // Update panCount and cook button text
